...
{index: 3, quickReplyButton: {displayText: '☙⃝✈️𝑽𝑬𝑳𝑶𝑪𝑰𝑫𝑨𝑫 𝑫𝑬𝑳 𝑩𝑶𝑻☙⃝🚀', id: '#ping'}},
{index: 4, quickReplyButton: {displayText: 'ⓞ⃟❗𝑰𝑵𝑭𝑶𝑹𝑴𝑨𝑪𝑰Ó𝑵𝑩𝑶𝑻ⓞ⃟♦', id: '#infobot'}},
{index: 5, quickReplyButton: {displayText: '🥀️⃟⃪͡ꦽ𝑴𝑬𝑵𝑼🔖️⃟⃪͡ꦽ', id: '#menu'}},
]
let tm = {
text: veloz,
footer: global.wm,
